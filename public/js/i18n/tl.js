...
window.I18N_TL = {
  ...
  modal_logout_body1: 'Tapusin ang sesyon?',
  modal_logout_body2: 'Mawawala ang hindi na-save na datos.',
  modal_logout_cancel: 'Kanselahin',
  modal_logout_confirm: 'Oo, Tapusin ang Sesyon',

  // Step 1: Pre-Qualification
  step1_heading: 'Paunang Kwalipikasyon',
  step1_subtext: 'Kumpirmahin ang pagiging miyembro sa 4Ps upang matulungan kaming i-coordinate ang iyong mga benepisyo.',
  step1_sec_heading: 'Miyembro ng 4Ps?',
  step1_sec_subtext: 'Ikaw ba ay miyembro ng Pantawid Pamilyang Pilipino Program?',
  step1_opt_yes_title: 'Oo',
  step1_opt_yes_sub: 'Ako ay miyembro ng 4Ps Program',
  step1_opt_no_title: 'Hindi',
  step1_opt_no_sub: 'Hindi ako miyembro ng 4Ps',
  ...
  step2_lbl_relationship: 'Relasyon sa Bata',
  step2_ph_relationship: 'Relasyon sa Bata',
  ...
  step3_lbl_ip: 'Kabilang sa IP',
  step3_sec_condition_edu: 'Kondisyon at Edukasyon',
  step3_lbl_education: 'Pinakamataas na antas ng Edukasyon',
  ...
  step4_sec_family_size: 'Kasalukuyang Bilang ng Pamilya',
  ...
  member_lbl_relationship: 'Relasyon sa Puno ng Pamilya',
  member_lbl_solo_parent: 'Solo Parent',
  member_lbl_claimant: 'Awtorisadong Claimant',
  member_lbl_civil_status: 'Estadong Sibil',
  member_lbl_age: 'Edad',
  member_ph_age: 'Edad',
  ...
  step6_opt_barriers_yes: 'Meron',
  step6_opt_barriers_no: 'Wala',
  ...
  step8_opt_employed_yes: 'Meron',
  step8_opt_employed_no: 'Wala',
  ...
  step10_sec_notes: 'Assessment',
  step10_lbl_strengths: 'Potensyal',
...
window.I18N_TL_DROPDOWNS = {
  ...
  List_RelationshipToHead: {
    'Head': 'Puno ng Pamilya',
    'Spouse': 'Asawa',
    'Child': 'Anak',
    'Parent': 'Magulang',
    'Sibling': 'Kapatid',
  ...
  List_Occupation: {
    ...
    'Employed (Private Sector)': 'Nagtatrabaho (Pribadong Sektor)',
    'Employed (Government)': 'Nagtatrabaho (Gobyerno)',
    ...
    'Vendor': 'Nagtitinda',
    'Driver': 'Driver',
    'Housewife/Househusband': 'Maybahay',
    'Student': 'Estudyante',
  ...
  List_Occupation_Class: {
    ...
    'Clerical': 'Klerikal',
    'Sales': 'Benta',
    'Service Worker': 'Manggagawa sa Serbisyo',
    'Agricultural Worker': 'Manggagawang Pang-agrikultura',
    'Production/Laborer': 'Produksyon/Manggagawa',
    'Elementary Occupation': 'Elementaryang Trabaho',
    'Not Applicable': 'Hindi Aplikable',
  },
  List_Education: {
